...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Création de compte client - MeryAcademi</title>
        ...
        <style>
            ...
            @media (min-width: 992px) {
                .register-image {
                    display: block;
                    flex: 0 0 50%; /* Réduit la taille de la partie gauche */
                }
                .register-container {
                    flex: 0 0 50%; /* Augmente la taille de la partie droite */
                }
            }
    ...
    <body>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" id="secretQuestion" name="secretQuestion" required>
                                ...
                                <div class="col-md-6">
                                    <label for="secretAnswer" class="form-label">Réponse à la question secrète</label>
                                    <input type="text" class="form-control" id="secretAnswer" 
                                           name="secretAnswer" placeholder="Entrez votre réponse" required>
                                    <small class="form-text">La réponse n'est pas sensible à la casse et les espaces sont ignorés.</small>
                                </div>
                            </div>
                        </div>
        ...
        <script>
                    ...
                    return true;
                            ...
                            // Ajouter un écouteur pour vérifier les mots de passe en temps réel
                            document.getElementById('confirmPassword').addEventListener('input', checkPasswordMatch);
                            document.getElementById('motDePasse').addEventListener('input', checkPasswordMatch);
        </script>
    </body>
</html>